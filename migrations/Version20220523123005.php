 ...
 */
final class Version20220523123005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE novedad ADD egreso DATETIME DEFAULT NULL, DROP tipo_id, CHANGE fecha fecha DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE novedad ADD tipo_id INT NOT NULL, DROP egreso, CHANGE fecha fecha DATETIME NOT NULL');
